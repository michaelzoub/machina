...
export default function Combined({color, secondary}: {color: string, secondary: string}) {
    ...
    return (
            <motion.div className={`shadow-lg shadow-neutral-500/50 flex flex-col h-[600px] w-[400px] mx-auto my-auto rounded-lg border-[1px] border-neutral-500 bg-neutral-800 px-0 flex flex-col overflow-hidden`}
